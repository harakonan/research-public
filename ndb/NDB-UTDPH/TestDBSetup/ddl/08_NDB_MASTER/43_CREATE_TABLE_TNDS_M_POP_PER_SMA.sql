CREATE TABLE TNDS_M_POP_PER_SMA
(
SCND_MEDI_AREA_CD            VARCHAR2 (4) NOT NULL ENABLE,
...
MST_GEN                      VARCHAR2 (9) NOT NULL ENABLE,
    CONSTRAINT TNDS_M_POP_PER_SMA_PK PRIMARY KEY (SCND_MEDI_AREA_CD,SEX,MST_GEN) USING INDEX
