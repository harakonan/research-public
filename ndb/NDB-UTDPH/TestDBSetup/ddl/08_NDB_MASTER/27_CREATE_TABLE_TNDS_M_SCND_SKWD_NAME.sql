CREATE TABLE TNDS_M_SCND_SKWD_NAME
(
MDC_CD                       VARCHAR2 (2) NOT NULL ENABLE,
CLS_CD                       VARCHAR2 (4) NOT NULL ENABLE,
CRSPD_CD                     VARCHAR2 (1),
SCND_SKWD_FLG                VARCHAR2 (1),
ICD_NAME                     NVARCHAR2(60),
...
MST_GEN                      VARCHAR2 (9) NOT NULL ENABLE,
    CONSTRAINT TNDS_M_SCND_SKWD_NAME_PK PRIMARY KEY (MST_GEN,MDC_CD,CLS_CD,ICD_CD) USING INDEX
