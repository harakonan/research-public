CREATE MATERIALIZED VIEW CMDS_M_THOKEN_PER parallel 96 nologging
AS
select distinct
...
from TNDS_T_TRANS_JC_YEAR
      INNER JOIN TNDS_T_THOKEN_BASE
       ON substr(TNDS_T_TRANS_JC_YEAR.SEIREKI,1,4) = TNDS_T_THOKEN_BASE.HGE_NENDO
