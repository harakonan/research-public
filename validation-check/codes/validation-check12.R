...
#HT
HSHT <- fread("path-to-workspace/Ex2Sc/HSReceHT1.csv")
HSHT
...
write.csv(HSFormerHT,"path-to-workspace/Ex2Sc/HSFormer/HSFormerHT1.csv", fileEncoding="UTF-8", row.names = F)

#DM
HSDM <- fread("path-to-workspace/Ex2Sc/HSReceDM1.csv")
HSDM
...
write.csv(HSFormerDM,"path-to-workspace/Ex2Sc/HSFormer/HSFormerDM1.csv", fileEncoding="UTF-8", row.names = F)

#DM_Robust
HSDM_Robust <- fread("path-to-workspace/Ex2Sc/HSReceDM1_Robust.csv")
HSDM_Robust
...
HSFormerDM_Robust
write.csv(HSFormerDM_Robust,"path-to-workspace/Ex2Sc/HSFormer/HSFormerDM1_Robust.csv", fileEncoding="UTF-8", row.names = F)

#DL
HSDL <- fread("path-to-workspace/Ex2Sc/HSReceDL1.csv")
HSDL
...
write.csv(HSFormerDL,"path-to-workspace/Ex2Sc/HSFormer/HSFormerDL1.csv", fileEncoding="UTF-8", row.names = F)
